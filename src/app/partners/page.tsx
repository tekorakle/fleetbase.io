...
export const metadata: Metadata = {
 ...
 description:
 'Join the Fleetbase partner program as an integration, implementation, technology, or reseller partner. Help your customers deploy open-source logistics infrastructure.',
 keywords: ['Fleetbase partners', 'fleetbase partner program', 'logistics partner program', 'open source logistics partners', 'fleetbase reseller'],
 openGraph: {
 title: 'Partner Program | Fleetbase',
...
export default function PartnersPage() {
 ...
 <section className="border-b py-12 md:py-16 bg-muted/20">
 <div className="container">
 <div className="mx-auto max-w-3xl rounded-2xl border bg-card p-8 text-center md:p-10">
 <div className="mb-2 text-sm font-medium uppercase tracking-wider text-muted-foreground">
 Looking for integrations?
 </div>
 <h2 className="mb-3 text-2xl font-bold tracking-tight md:text-3xl">
 See what Fleetbase plugs into
 </h2>
 <p className="mb-6 text-muted-foreground">
 Maps, payments, communication, cloud, e-commerce, and developer tooling — all
 available natively or through the Extensions Marketplace.
 </p>
 <Button asChild>
