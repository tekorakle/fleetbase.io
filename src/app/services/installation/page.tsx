      ...
      <section className="py-4">
        <div className="container mx-auto px-4 max-w-3xl">
          <p className="text-xs text-center text-muted-foreground">
            ...
            <Link href="/services/installation/terms" className="underline underline-offset-4 hover:text-foreground transition-colors">
              Fleetbase Console & Core Implementation Terms and Conditions
            </Link>
