...
export default function LedgerPage() {
 ...
 Start your free trial to explore the full power of Ledger. Connect your operations to your finances and get a real-time view of your business health — .
 </p>
 ...
 <p className="text-sm text-muted-foreground mt-6"> Full platform access · Cancel anytime
 </p>
 </div>
 </section>
 </div>
