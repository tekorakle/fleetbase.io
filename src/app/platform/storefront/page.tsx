...
console.log(order.total); // 2450 ($24.50)`}
 ...
 <AccordionContent>
 The 14-day free trial includes full access to all Storefront features: product management, mobile apps, marketplace capabilities, FleetOps integration, API access, and more. , and you can cancel anytime.
 </AccordionContent>
 </AccordionItem>
 </Accordion>
 </div>
