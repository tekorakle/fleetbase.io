...
<Steps>
  ...
  <Step>
    ...
    ![Profile Auth tab — 2FA method selector and enable toggle below the Change Password panel](/images/placeholder.png)
  </Step>
  <Step>
    ### Choose a Method
...
![Organization Two Factor settings — Enable 2FA toggle and Require Users to Set-Up 2FA toggle](/images/placeholder.png)
