...
![Policies list — Name, Description, Service, Type, Created columns](/images/placeholder.png)
...
![Policy form — Name, Description, and Permission Picker grid](/images/placeholder.png)
...
![Policy Attacher — search field and list of selected policies](/images/placeholder.png)
