...
![Admin Organizations list — organization name, owner, country, and creation date](/images/placeholder.png)
...
![Profile Organizations panel — list of organization memberships with Switch, Edit, Leave, and Delete actions](/images/placeholder.png)
...
![Edit organization form — name, description, and settings fields](/images/placeholder.png)
