...
![API Keys list — Name, Public Key, Secret Key, Environment badge, Expiry, Last Used columns](/images/placeholder.png)
...
![API Key form — Name field, Expiration dropdown, and Test/Live environment badge](/images/placeholder.png)
