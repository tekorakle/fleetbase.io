...
![System Events list — Event description, Code, ID, and Date columns](/images/placeholder.png)
...
![System Event detail — Details panel with event metadata and Data panel with full JSON payload](/images/placeholder.png)
