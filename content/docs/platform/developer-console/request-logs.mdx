...
![Request Logs list — Description, Status badge, ID, API Credential, Method, Version, Date columns](/images/placeholder.png)
...
![Request Log detail — Details, Query Params, Request Headers, Request Body, and Response Body panels](/images/placeholder.png)
