...
![Socket Events list — Listen button and Channel name columns for each available channel](/images/placeholder.png)
...
![Channel live view — black terminal panel with green monospace event output and timestamps](/images/placeholder.png)
...
![Listen on custom channel modal — channel ID input and Listen button](/images/placeholder.png)
