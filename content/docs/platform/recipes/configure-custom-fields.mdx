...
<Steps>
  ...
  <Step>
    ...
    ![Custom Fields Manager — resource type tabs across the top with field groups below](/images/placeholder.png)
  </Step>
  <Step>
...
![Custom field form — Label, Type selector, Required and Editable toggles, Column Span](/images/placeholder.png)
