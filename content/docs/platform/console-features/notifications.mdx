...
![Notification Tray — unread count badge, notification list with subject and preview, View all link](/images/placeholder.png)
...
![Full Notifications page — Select All, Mark as Read, Delete buttons, and notification rows with checkbox, envelope, subject, and timestamp](/images/placeholder.png)
