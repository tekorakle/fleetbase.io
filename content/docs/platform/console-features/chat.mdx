...
![Chat Tray — Start Chat button, channel list with name, unread badge, avatar, and last message preview](/images/placeholder.png)
...
![Chat window — channel name with pencil, participant avatar strip with online indicators, message feed, and Send button](/images/placeholder.png)
