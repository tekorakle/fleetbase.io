...
![Home dashboard — GridStack widget grid with stat cards, charts, and extension widgets](/images/placeholder.png)
...
![Dashboard selector — named dashboards list with the Default Dashboard option](/images/placeholder.png)
...
![Widget Panel — right-side overlay with search field and scrollable widget card list](/images/placeholder.png)
