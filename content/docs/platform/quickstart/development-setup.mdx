...
Then install dependencies to resolve the links. Inside the console container (Path A):
...
See the [flb scaffold command reference](/docs/cli/extension-development/scaffold) for all available flags, and the [Extension SDK Quickstart](/docs/sdk/getting-started/quickstart) for a full walkthrough of building and registering a new extension.
