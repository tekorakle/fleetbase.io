...
![Work orders list — code, subject, target, assignee, priority, status, and due date](/images/placeholder.png)
...
| `assigned` | Assigned to a mechanic or team |
| `in_progress` | Work has begun |
| `pending_review` | Work complete, awaiting supervisor sign-off |
| `completed` | Closed with all checklist items done |
