...
In the console, geofence triggers are part of the service area / zone edit modal — there is no separate "Geofences" page in the UI. To turn an existing polygon into a geofence:

1. Open the service area or zone in the map view.
2. Click **Edit**.
3. In the **Geofence Triggers** section, toggle entry / exit and set the dwell or speed-limit value.
