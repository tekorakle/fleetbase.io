...
In the console, open the parent service area in the map view and click **Add Zone**, or use the **Zones** panel in the map toolbar.

<Steps>
  <Step>
    **Pick a parent service area.** A zone must belong to exactly one service area — if you find yourself wanting a "freestanding" zone, model it as a service area instead.
  </Step>
  <Step>
  ...
  <Step>
    **Save.** The zone appears in the parent service area's zone list and on the live map.
  </Step>
</Steps>
