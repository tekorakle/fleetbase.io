...
We love your input! We want to make contributing to Fleetbase as easy and transparent as possible, whether it's:
...
We use GitHub issues to track public bugs. Report a bug by [opening a new issue](https://github.com/fleetbase/fleetbase/issues/new); it's that easy!
